      ...
      <div className="navbar flex items-center justify-between px-4">
        ...
        <div className="hidden lg:flex absolute left-1/2 transform -translate-x-1/2">
          <div className="flex items-center gap-1.5 bg-[#0f0f0f] text-white px-4 py-1.5 rounded-full shadow-lg border border-gray-700 backdrop-blur-md">
            ...
            <Link
              to="/"
              className="flex items-center gap-1 bg-gray-800 px-2.5 py-1.5 rounded-full transition-transform duration-200 hover:scale-100 cursor-pointer"
            >
            ...
            <Link
              to="/about"
              className="flex items-center gap-1.5 hover:text-primary cursor-pointer px-2 py-1.5 text-sm"
            >
