...
function Footer() {
  return (
    <>
      <div>
        <footer className="mt-8 shadow-md flex flex-col footer text-neutral-content items-center p-4 text-white">
          <aside className="grid-flow-col items-center">
            ...
            <p>Made with ❤️ by Pritam Anand {new Date().getFullYear()}</p>
          </aside>

          <nav className="grid-flow-col gap-4 mt-2 md:place-self-center md:justify-self-end">
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/in/pritam-anand-" target="_blank" rel="noopener noreferrer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 24 24"
